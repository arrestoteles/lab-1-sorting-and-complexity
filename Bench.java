...
public class Bench {
    ...
    public static void main(final String[] args) {
        ...
        // executionTimeReport("Quick.java: quicksort with shuffle", new Quick(true, false, 0)::sort);
        //executionTimeReport("Quick.java: quicksort with median of three", new Quick(false, true, 0)::sort);
        //executionTimeReport("Quick.java: quicksort with insertion sort for sub arrays", new Quick(false, false, 42)::sort);
    ...
    // The sample sizes and degrees of sortedness (0-100) the benchmarking program uses.
        ...
        while(true) {
            ...
            if (runtime >= target) {
                ...
                if (runtime == 0)
                    ...
                    double factor = (double) target / runtime;
    ...
    private static void executionTimeReport(String name, Consumer<int[]> algorithm) {
        ...
        BiFunction<Object, Stream<Object>, String> makeRow =
            ...
            Stream.concat(Stream.of(size).map(pad.apply(sizeLength)), stream.map(centre.apply(timeLength))));
        ...
        runWithLargeStack(32 * 1024 * 1024, () -> {
            try {
                ...
                System.out.println(makeRow.apply("", Arrays.stream(RANDOMNESS).mapToObj(Bench::getRandomnessDescription)));
